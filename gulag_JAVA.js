...
//------------rester dans la meme langue oop



// //---------------HOW querySelector works-----------------//
// // const woody = document.querySelector(/* # for id . for class*/)

// // const woody = document.querySelector(.woody);
// // woody.onclick = function(){
// //     console.log("I like turtles")
// // }

// // const artist = document.querySelector("artist")
// // artist.classList.add(".mask")

// // const queen = document.querySelector('.band');
// // console.log(queen) /* .band to search for the right class, add the variable which is queen in this situation */
// const gulagventure = {
//     subtitle: `Gulag Island`, 
//     text:`L'aventure commence, vous arrivez enfin sur l'ile de Fortuna. "Gul: Enfin arrivé! Hé hé, on va être riche!". Trois choix s'offre a vous:`,
//     img: ``,
